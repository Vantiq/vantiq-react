...
public class VLog
{
    ...
    public void send()
    {
        ...
        if (this.currentFileWriter != null)
        {
            ...
            Context ctx = VantiqInterfaceLibraryModule.INSTANCE.application;
            ...
            String subject = "Android Logs from " + VantiqInterfaceLibraryModule.INSTANCE.currentAccount.HRusername;
            ...
            String body =
                    "Username: " + VantiqInterfaceLibraryModule.INSTANCE.currentAccount.HRusername + "\n" +
                            "Userid: " + VantiqInterfaceLibraryModule.INSTANCE.currentAccount.username + "\n" +
                            "Namespace: " + VantiqInterfaceLibraryModule.INSTANCE.currentAccount.currentNamespace + "\n" +
                            "Server: " + VantiqInterfaceLibraryModule.INSTANCE.currentAccount.server + "\n" +
                            "App: " + txt1 + "\n" +
            ...
            try
            {
                File logsDir = new File(ctx.getFilesDir(), VantiqInterfaceLibraryModule.FS_LOGS);

                File logCopyFile = new File(logsDir, VantiqInterfaceLibraryModule.logCopyFileName);
    ...
    public void initLogs()
    {
        ...
        Context ctx = VantiqInterfaceLibraryModule.INSTANCE.getApplicationContext();
        ...
        this.logFile1 = new File(logsDir, VantiqInterfaceLibraryModule.log1FileName);
        long logFile1LastModified = 0;

        this.logFile2 = new File(logsDir, VantiqInterfaceLibraryModule.log2FileName);
